...
public class DashboardSiswa extends JFrame {
    ...
    public DashboardSiswa() {
        ...
        setTitle("Dashboard PPDB SMK Tadika Mesra");
        setSize(1200, 700);
        setResizable(false);
        ...
        ImageIcon logoIcon = new ImageIcon(getClass().getResource("/gambar/icon-dashboard-9.png"));
        JLabel lblTitle = new JLabel("PPDB SMK TADIKA MESRA", logoIcon, SwingConstants.CENTER);
...
add(lblWelcome);
        ...
        JButton btnDataDiri = createMenuButton("Data Diri", new Color(255, 167, 38));
        JButton btnVerifikasi = createMenuButton("Status Verifikasi dan Seleksi", new Color(144, 202, 249));
        ...
        panelMenu.add(btnVerifikasi);
        panelMenu.add(btnPengumuman);
        panelMenu.add(btnStatistik);

        // Action Listeners
        btnDataDiri.addActionListener(e -> {
            JFrame formFrame = new JFrame("Formulir Pendaftaran");
            formFrame.setContentPane(new PanelFormPendaftaran(idUser));
            formFrame.setSize(700, 550);
        ...
        btnVerifikasi.addActionListener(e -> {
            new FormSeleksiVerifikasi(idUser).setVisible(true);
        });

        btnPengumuman.addActionListener(e -> {
            new FormPengumumanSiswa().setVisible(true);
        });

        btnStatistik.addActionListener(e -> {
            new FormStatistikSiswa(idUser).setVisible(true);
        });
    }
